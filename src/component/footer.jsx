      ...
      <div className="app-footer">
        <div className="address-detail">
          <div className="contact-details">
            ...
            <p>
              <a href="https://wa.me/+6281xxxxxxxx" className="footer-text">
                081xxxxxxxx
              </a>
            </p>
          </div>
          <div className="contact-details">
            ...
            <p>
              {" "}
              <a
                href="https://goo.gl/maps/GpjMTqSTKenzxpkw8"
                className="footer-text"
              >
                Jl. Damaiku No 001 <br />
                Bekasi
              </a>
            </p>
          </div>
          <div className="contact-details">
            ...
            <p>
              <a href="mailto:info@rsmartcomm.com" className="footer-text">
                info@rachwn.com
              </a>
            </p>
          </div>
